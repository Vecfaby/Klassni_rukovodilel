...
namespace Klassni_rukovodilel_
{
    public partial class FormStudent9 : Form
    {
        ...
        private void students9BindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.students9BindingSource.EndEdit();
        ...
        {
            students9TableAdapter.Update(klassRukDataSet);
